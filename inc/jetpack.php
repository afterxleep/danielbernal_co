 ...
 */
function danielbernal_co_jetpack_setup() {
	/*
	...
	add_theme_support( 'infinite-scroll', array(
		'container' => 'main',
		'render'    => 'danielbernal_co_infinite_scroll_render',
		'footer'    => 'page',
	) );
	...
	add_theme_support( 'jetpack-content-options', array(
		...
		'author-bio'      => true,
		'post-details'    => array(
			'stylesheet' => 'danielbernal-co-style',
...
add_action( 'after_setup_theme', 'danielbernal_co_jetpack_setup' );

/**
 * Custom render function for Infinite Scroll.
 */
function danielbernal_co_infinite_scroll_render() {
 ...
 */
function danielbernal_co_social_menu() {
...
if ( function_exists( 'jetpack_is_mobile' ) && ! function_exists( 'danielbernal_co_has_footer_widgets' ) ) {

    function danielbernal_co_has_footer_widgets() {
...
add_filter( 'infinite_scroll_has_footer_widgets', 'danielbernal_co_has_footer_widgets' );

/**
 * Return early if Author Bio is not available.
 */
function danielbernal_co_author_bio() {
 ...
 */
function danielbernal_co_author_bio_avatar_size() {
	return 80;
}
add_filter( 'jetpack_author_bio_avatar_size', 'danielbernal_co_author_bio_avatar_size' );

/**
 * Fall back to has_post_thumbnail() if jetpack_has_featured_image is not available
 */
function danielbernal_co_has_post_thumbnail( $post = null ) {
 ...
 */
function danielbernal_co_jetpack_featured_image_display() {
